...
{
    if(e.clientX > get("hand1").offsetWidth-215 || e.clientY < get("hand1").offsetTop)
    {
...
{
    if(e.clientX > get("hand2").offsetWidth-215 || e.clientY > get("hand2").offsetHeight)
    {
