...
function loadDecks()
{
    ...
    data+="hand1[0]=none&hand1[1]=0&"
    data+="hand2[0]=none&hand2[1]=0&"
    data+="deck1[0]=none&deck1[1]=0&"
    for(var i=0;i<deck1.length;i++)
    {
        data+="deck1["+(i+2)+"]="+deck1[i]+"&";
    }
    data+="deck2[0]=none&deck2[1]=0&"
    for(var i=0;i<deck2.length;i++)
    {
        data+="deck2["+(i+2)+"]="+deck2[i]+"&";
    }
    data+="grave1[0]=none&grave1[1]=0&"
    data+="grave2[0]=none&grave2[1]=0&"
